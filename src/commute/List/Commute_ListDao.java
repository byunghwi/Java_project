...
public class Commute_ListDao {
	...
	public Commute_ListDao(String start_date,String end_date,String mem_name) {
		...
		String sql = "SELECT TO_CHAR(dc_date, 'YYYY/MM/DD')as dc_date,mem_no,TO_CHAR(on_time,'HH24:Mi:ss')as on_time,TO_CHAR(off_time,'HH24:Mi:ss')as off_time FROM daily_check WHERE dc_date between to_date(?,'YYYY-MM-dd ') and to_date(?,'YYYY-MM-dd') and mem_no= ?";
